...
import { Box, HStack, Pressable, Icon, Center, Avatar, FlatList } from 'native-base';
        ...
        <Box flex={1} backgroundColor="#f8f8f8" flexDirection='column'>
            ...
            <HStack padding={4} w='100%' alignItems='center' justifyContent="space-between" safeArea>
                ...
                <Box rounded='md' flexDir='row' alignItems='center'>
                    ...
                    <Pressable>
                        <Avatar
                            source={{ uri: "https://pbs.twimg.com/profile_images/1318656331809783808/1SkLKePf_400x400.jpg" }}
                            height={12}
                            width={12}
                        />
                    </Pressable>
